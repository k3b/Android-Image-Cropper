...
final class BitmapCroppingWorkerTask
        ...
        try {
            if (!isCancelled()) {
                ...
                if (mSaveUri == null) {
                    ...
                    File file = BitmapUtils.writeBitmapToUri(
                            mContext, bitmap, mSaveUri, mSaveCompressFormat, mSaveCompressQuality);
                    if (bitmap != null) {
                        bitmap.recycle();
                    }
                    return new Result(file, mSaveUri, bitmapSampled.sampleSize);
                }
            }
            return null;
        } catch (Exception e) {
    ...
    static final class Result {
        ...
        Result(File file, int sampleSize) {
            this.bitmap = null;
            this.file = file;
            this.uri = null;
            this.error = null;
        ...
        Result(File file, Uri uri, int sampleSize) {
            this.bitmap = null;
            this.file = null;
            this.uri = uri;
            this.error = null;
