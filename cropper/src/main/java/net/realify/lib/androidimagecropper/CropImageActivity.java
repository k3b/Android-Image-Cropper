...
public class CropImageActivity extends AppCompatActivity
    ...
    public void onSetImageUriComplete(CropImageView view, Uri uri, Exception error) {
        if (error == null) {
            ...
            setResult(null, null, error, 1);
        }
    }

    @Override
    public void onCropImageComplete(CropImageView view, CropImageView.CropResult result) {
        setResult(result.getFile(), result.getUri(), result.getError(), result.getSampleSize());
    }
     ...
     */
    protected void setResult(File file, Uri uri, Exception error, int sampleSize) {
        int resultCode = error == null ? RESULT_OK : CropImage.CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE;
        setResult(resultCode, getResultIntent(file, uri, error, sampleSize));
        finish();
    }
     ...
     */
    protected Intent getResultIntent(File file, Uri uri, Exception error, int sampleSize) {
